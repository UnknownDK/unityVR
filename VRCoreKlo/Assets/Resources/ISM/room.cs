...
public class Room {
    private double[,,] wallVertices = new double[,,]  
        {{ {0, 0, 0}, {4.130, 0, 0}, {4.130, 0, 2.130}, {0, 0, 2.130} },   //front     
        { {0, 0, 0}, {4.130, 0, 0}, {4.130, 7.790, 0}, {0, 7.790, 0} },    //bund     
        { {4.130, 0, 0}, {4.130, 7.790, 0}, {4.130, 7.790, 2.130}, {4.130, 0, 2.130} },    //højre side 
        { {4.130, 0, 2.130}, {4.130, 7.790, 2.130}, {0, 7.790, 2.130}, {0, 0, 2.130} },    //top   
        { {0, 0, 0}, {0, 7.790, 0}, {0, 7.790, 2.130}, {0, 0, 2.130} },    //venstre side  
        { {4.130, 7.790, 0}, {4.130, 7.790, 2.130}, {0, 7.790, 2.130}, {0, 7.790, 0} }};   //bagside
